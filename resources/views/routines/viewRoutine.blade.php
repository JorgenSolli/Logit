<form id="routines" method="POST" action="/dashboard/my_routines/edit/{{ $routine->id }}">
  ...
  <div class="modal-footer">
    ...
    @if ($routine->active == 1)
      <button type="button" id="changeStatus" class="btn btn-default pull-left" role="button"><span class="fa fa-lock"></span> Set inactive</button>
    @else
      <button type="button" id="changeStatus" class="btn btn-default pull-left" role="button"><span class="fa fa-unlock"></span> Set active</button>
    @endif

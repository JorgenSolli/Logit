          ...
          '<div class="row">' +
            '<div class="col-xs-12 col-sm-6">' +
              '<div class="form-group m-t-10 label-floating">' +
                '<label class="bmd-label-floating" for="exercise_name">Excersice name</label>' +
          ...
          '<div class="row">' +
            '<div class="col-md-8 col-xs-6">' +
              '<div class="form-group label-floating">' +
                '<label class="bmd-label-floating" for="media">Media</label>' +
        ...
        '<div class="card card-transparent m-t-10 m-b-10">' +
          '<div class="card-body">' +
            '<div class="sortable-content">' +
              ...
              '</div>' +
              '<div class="form-group label-floating">' +
                '<label class="bmd-label-floating" for="exercise_name">Superset Name</label>' +
...
$(document).on('click', '#addRoutine', function() {
    ...
    $(".required").each(function() {
        if ($(this).val() == "" || $(this).val() == null) {
            $(this).closest(".form-group").addClass("has-danger").find(".bmd-label-floating").removeClass("hidden")
            ok = false
        } else {
            $(this).closest(".form-group").removeClass("has-danger").find(".bmd-label-floating").addClass("hidden")
        }
    });
